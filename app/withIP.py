...
def send_mail(name):
    ...
    msg.body = 'Hi there ' +  name + message
    mail.send(msg)
    return "Sent"
...
app.config["MONGO_URI"] = "mongodb://localhost:27017/registry"
...
img_counter = 0
cntr = 0
# camera=cv2.VideoCapture('http://192.168.1.105:4747/mjpegfeed?640x480')
...
def generate_frames():
    ...
    # all the opencv processing is done here
            ...
            text = pytesseract.image_to_string(frame, config='-l eng --oem 1 --psm 6')
